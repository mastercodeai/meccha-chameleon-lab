...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Social Proof Bar */}
      <section ref={statsRef} className="grid grid-cols-2 md:grid-cols-5 gap-4 pt-6 pb-8 border-y border-[#1e1e32] mt-4 mb-stack-lg bg-surface/20 max-w-[1440px] mx-auto px-4">
        {stats.map((stat) => (
