  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Link
          href="/maps"
          className="border border-primary text-primary font-label-caps text-label-caps px-8 py-4 rounded hover:bg-primary/10 transition-all"
        >
          BROWSE MAPS
        </Link>
        <Link
          href="/guides/beginner"
          className="border border-secondary text-secondary font-label-caps text-label-caps px-8 py-4 rounded hover:bg-secondary/10 transition-all"
        >
          BEGINNER GUIDE
        </Link>
      </div>
